...
subtitle: "Adult Mosquito Behavioral State Models with Blood Feeding and Egg Laying"
date: "`r format(Sys.time(), '%B %d, %Y')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{The BQ Modules}
...
The `xds_setup()` utilities does not allow the user to set up two different dispersal matrices. pass a single version of the dispersal matrix `K_matrix.`  During `xds_setup()`, `Omega_b` and `Omega_q` are identical.  
