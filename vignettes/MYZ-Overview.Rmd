...
**`ramp.library`** aims to build a comprehensive code library for models of adult mosquito ecology, behaviors, and infection dynamics. The following is a short overview of existing model families. 
