...
output:
  html_document:     
    theme: paper 
vignette: >
  %\VignetteIndexEntry{The SIR Model}
...
The SIR model, as it is now called, is a simple compartmental model, first introduced by Ross. It is included in `ramp.xde`` as a base model. 
