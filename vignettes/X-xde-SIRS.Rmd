---
title: "The SIRS Model"
date: "`r format(Sys.time(), '%B %d, %Y')`"
output:
  html_document:     
    theme: paper 
vignette: >
  %\VignetteIndexEntry{The SIRS Model}
...
The SIRS model, as it is now called, is a simple compartmental model, first introduced by Ross. It is included in `ramp.xde`` as a base model. 
