...
output:
  html_document:     
    theme: paper 
vignette: >
  %\VignetteIndexEntry{The SEIR Model}
...
The SEIR model, as it is now called, is a simple compartmental model, first introduced by Ross. It is included in `ramp.xde`` as a base model. 

**Copied from SIS -- needs updating.** 
