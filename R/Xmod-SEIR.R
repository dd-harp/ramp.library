...
#'
#' @param XH a list with the outputs of parse_deout_X_SEIR
...
#' @export
xde_plot_X.SEIR = function(pars, i=1, clrs=c("black","darkblue","darkred","darkgreen"), llty=1, stable=FALSE, add_axes=TRUE){
