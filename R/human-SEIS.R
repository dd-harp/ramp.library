...
#' @return a [numeric] vector of length `nStrata`
#' @export
F_prevalence.SEIS <- function(vars, Xpar) {
  pr = with(vars, I/H)
  return(pr)
}
...
#' @return a [numeric] vector of length `nStrata`
#' @export
F_prevalence_lm.SEIS <- function(vars, Xpar) {
  pr = with(vars, I/H)
  return(pr)
}
...
#' @return a [numeric] vector of length `nStrata`
#' @export
F_prevalence_rdt.SEIS <- function(vars, Xpar) {
  pr = with(vars, I/H)
  return(pr)
}
...
#' @return a [numeric] vector of length `nStrata`
#' @export
F_prevalence_pcr.SEIS <- function(vars, Xpar) {
  pr = with(vars, I/H)
  return(pr)
}
